...
public class MyOrdersShowAdapter extends RecyclerView.Adapter<MyOrdersShowAdapter.MyOrdersShowViewHolder>{
    ...
    public void onBindViewHolder(@NonNull MyOrdersShowAdapter.MyOrdersShowViewHolder holder, int position) {
        ...
        holder.tv_count.setText("Քանակ: " + listItem.getCount2() + " հատ");
        holder.tv_price.setText("Արժեք: " + listItem.getPrice2() + " AMD");
        holder.tv_total_price.setText("Ընդհանուր գումար: " + listItem.getTotalPrice2() + " AMD");

        Glide
                .with(context)
                .load(listItem.getImg2())
                .centerCrop()
